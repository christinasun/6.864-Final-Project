...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Question Retrieval Adversarial Direct Transfer from AskUbuntu to Android')
    # learning
    parser.add_argument('--encoder_lr', type=float, default=0.001, help='initial learning rate [default: 0.001]')
    parser.add_argument('--domain_classifier_lr', type=float, default=0.001,
    ...
    # model
    parser.add_argument('--model_name', nargs="?", type=str, default='adt-lstm', help="model: adt-lstm")
    ...
    # task
    parser.add_argument('--encoder_snapshot', type=str, default=None, help='snapshot filename to load[default: None]')
    parser.add_argument('--domain_classifier_snapshot', type=str, default=None, help='snapshot filename to load[default: None]')
    ...
    if args.train:
        ...
        label_predictor_train_data = AskUbuntuDataset('train', word_to_indx, max_seq_length=args.len_query,
    ...
    if args.train:
        ...
        adt_train_utils.train_model(label_predictor_train_data, adversary_train_data_generator, android_dev_data,
